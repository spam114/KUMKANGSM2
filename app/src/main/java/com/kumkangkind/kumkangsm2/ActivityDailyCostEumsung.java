...
public class ActivityDailyCostEumsung extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dailycost_eumsung);

        type = Typeface.createFromAsset(getAssets(),"fonts/sangsang.ttf");
    ...
    private void CallDateDialog() {
        try {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(ActivityDailyCostEumsung.this, mDateSetListener1, mYear, mMonth, mDay);
...
*/
        ...
        TableRow tr_Cost12 = new TableRow(this);
        for (int i = 0; i < monthList.size(); i++) {
            ...
            tvNo.setBackgroundResource(R.drawable.background_tablecell);
            tvNo.setTag(R.id.costDate, monthList.get(i));
            tvNo.setTag(R.id.costType, "12");
            tvNo.setPadding(10, 25, 0, 25);
            tvNo.setClickable(true);
            tvNo.setOnClickListener(mOnclickListener);
            tvNo.setGravity(Gravity.RIGHT | Gravity.CENTER_VERTICAL);
            tvNo.setTypeface(type);
            tr_Cost12.addView(tvNo);
        }
        t1.addView(tr_Cost12, new TableLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));



        TableRow tr_CostTotal = new TableRow(this);
        for (int i = 0; i < monthList.size(); i++) {
            ...
            tvNo.setGravity(Gravity.RIGHT | Gravity.CENTER_VERTICAL);
            tvNo.setTypeface(type);
            tr_CostTotal.addView(tvNo);
        }
        t1.addView(tr_CostTotal, new TableLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    dailyCost.Cost11A = child.getString("Cost11A");
                    dailyCost.Cost11B = child.getString("Cost11B");
                    dailyCost.Cost11C = child.getString("Cost11C");
                    dailyCost.Remark11A = child.getString("Remark11A");
                    dailyCost.Remark11B = child.getString("Remark11B");
                    dailyCost.Remark11C = child.getString("Remark11C");

                    dailyCost.Cost12 = child.getString("Cost12");
                    dailyCost.Cost12A = child.getString("Cost12A");
                    dailyCost.Cost12B = child.getString("Cost12B");
                    dailyCost.Cost12C = child.getString("Cost12C");
                    dailyCost.Remark12A = child.getString("Remark12A");
                    dailyCost.Remark12B = child.getString("Remark12B");
                    dailyCost.Remark12C = child.getString("Remark12C");
    ...
    private void ShowDialog(DailyCost2 dailyCost2, String costType, String type, String costDate, final TextView textView) {
        ...
        switch (costType) {
            ...
            case "10":
                ...
                break;
            case "11":
                remarkA = dailyCost2.Remark11A;
                remarkB = dailyCost2.Remark11B;
                remarkC = dailyCost2.Remark11C;
                amountA = dailyCost2.Cost11A;
                amountB = dailyCost2.Cost11B;
                amountC = dailyCost2.Cost11C;
                break;

            case "12":
                remarkA = dailyCost2.Remark12A;
                remarkB = dailyCost2.Remark12B;
                remarkC = dailyCost2.Remark12C;
                amountA = dailyCost2.Cost12A;
                amountB = dailyCost2.Cost12B;
                amountC = dailyCost2.Cost12C;
                break;
    ...
    Handler mHandler2 = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (costType) {
                ...
                case "11":
                    dailyCost.Remark11A = remarkA;
                    dailyCost.Remark11B = remarkB;
                    dailyCost.Remark11C = remarkC;
                    dailyCost.Cost11A = amountA;
                    dailyCost.Cost11B = amountB;
                    dailyCost.Cost11C = amountC;
                    break;
                case "12":
                    dailyCost.Remark12A = remarkA;
                    dailyCost.Remark12B = remarkB;
                    dailyCost.Remark12C = remarkC;
                    dailyCost.Cost12A = amountA;
                    dailyCost.Cost12B = amountB;
                    dailyCost.Cost12C = amountC;
                    break;
                default:
                    break;
            }
