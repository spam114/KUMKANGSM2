package com.kumkangkind.kumkangsm2.FloatingNavigationView;
...
public class FloatingNavigationView extends FloatingActionButton {
    ...
    /**
     * {@link FloatingNavigationView.SavedState} methods
     */

    @Override
    protected Parcelable onSaveInstanceState() {
        Parcelable superState = super.onSaveInstanceState();
        FloatingNavigationView.SavedState ss = new FloatingNavigationView.SavedState(superState);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        FloatingNavigationView.SavedState ss = (FloatingNavigationView.SavedState) state;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return FloatingNavigationView.class.getSimpleName() + "." + FloatingNavigationView.SavedState.class.getSimpleName() + "{"
                    + Integer.toHexString(System.identityHashCode(this))
                    + " opened=" + opened + "}";
        }

        public static final Parcelable.Creator<FloatingNavigationView.SavedState> CREATOR
                = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<FloatingNavigationView.SavedState>() {
            @Override
            public FloatingNavigationView.SavedState createFromParcel(Parcel parcel, ClassLoader loader) {
                return new FloatingNavigationView.SavedState(parcel, loader);
            }

            @Override
            public FloatingNavigationView.SavedState[] newArray(int size) {
                return new FloatingNavigationView.SavedState[size];
            }
        });
    }
}
