...
public class LocationProgressAdapter2 extends ArrayAdapter<LocationProgress> implements BaseActivityInterface {
   ...
   /* String lastPart;//마지막에 추가된 품목,규격
    ...
    public LocationProgressAdapter2(Context context, int layoutResourceID, ArrayList data, int type) {
